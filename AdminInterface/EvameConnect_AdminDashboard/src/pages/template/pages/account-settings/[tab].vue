...
const route = useRoute('template-pages-account-settings-tab')
...
definePage({ meta: { navActiveLink: 'template-pages-account-settings-tab' } })
</script>
  ...
  <div>
    ...
    >
      <VTab
        ...
        :key="item.icon"
        :value="item.tab"
        :to="{ name: 'template-pages-account-settings-tab', params: { tab: item.tab } }"
      >
        <VIcon
          size="20"
          start
