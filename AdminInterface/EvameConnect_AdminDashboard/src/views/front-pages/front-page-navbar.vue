...
const menuItems = [
  ...
  },
  {
    ...
    navItems: [
      {
        name: 'Login (Basic)',
        to: { name: 'template-pages-authentication-login-v1' },
      },
      {
        name: 'Login (Cover)',
        to: { name: 'template-pages-authentication-login-v2' },
      },
      {
        name: 'Register (Basic)',
        to: { name: 'template-pages-authentication-register-v1' },
      },
      {
        name: 'Register (Cover)',
        to: { name: 'template-pages-authentication-register-v2' },
      },
      {
        name: 'Register (Multi-steps)',
        to: { name: 'template-pages-authentication-register-multi-steps' },
      },
      {
        name: 'Forgot Password (Basic)',
        to: { name: 'template-pages-authentication-forgot-password-v1' },
      },
      {
        name: 'Forgot Password (Cover)',
        to: { name: 'template-pages-authentication-forgot-password-v2' },
      },
      {
        name: 'Reset Password (Basic)',
        to: { name: 'template-pages-authentication-reset-password-v1' },
      },
      {
        name: 'Reset Password (cover  )',
        to: { name: 'template-pages-authentication-reset-password-v2' },
      },
    ],
  },
  {
    ...
    navItems: [
      ...
      },
      {
        ...
        to: { name: 'template-pages-authentication-verify-email-v1' },
      },
      {
        name: 'Verify Email (Cover)',
        to: { name: 'template-pages-authentication-verify-email-v2' },
      },
      {
        name: 'Two Steps (Basic)',
        to: { name: 'template-pages-authentication-two-steps-v1' },
      },
      {
        name: 'Two Steps (Cover)',
        to: { name: 'template-pages-authentication-two-steps-v2' },
      },
    ],
  },
]
