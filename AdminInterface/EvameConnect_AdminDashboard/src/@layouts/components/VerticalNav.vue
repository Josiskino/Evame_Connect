    ...
    <div class="nav-header">
      <slot name="nav-header">
        ...
        <div class="header-action">
          ...
          <button
            class="nav-pin-toggle d-none d-lg-flex"
            :class="{ 'is-pinned': !configStore.isVerticalNavCollapsed }"
            :title="configStore.isVerticalNavCollapsed ? 'Fixer le menu' : 'Réduire le menu'"
